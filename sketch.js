...
ground.velocityX = -(4+ Math.round(score/100));
 ...
 //create a invisibleGround sprite 
  invisibleGround= createSprite(60,190,50,10)
  ...
  // creating restart
  restart=createSprite(200,150,30,10);
